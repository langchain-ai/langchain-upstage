...
from langchain_upstage.universal_information_extract import UpstageUniversalInformationExtraction
from langchain_upstage.prebuilt_information_extract import UpstagePrebuiltInformationExtraction
